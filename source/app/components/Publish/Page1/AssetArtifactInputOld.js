          ...
          <ModalWrapper
            ...
            <TextInput
              ...
              onChange={this.handleChangeName}
                />
            {/* Artifact Upload Doc */}
           {!this.isLink(this.state.type) && this.state.type!==''&&  <FileUploader
            ...
            {this.isLink(this.state.type) && <TextInput
              labelText='URL:'
              id='URL'
              value={this.state.url}
              onChange={this.handleChangeUrl}
              disabled={!this.isLink(this.state.type)}
                />}
            ...
            <TextArea
              ...
              onChange={this.handleChangeDescription}
                />
            {/* Artifact Confidential Flag */}
            {/* <Toggle labelA='' labelB='IBM Confidential' defaultToggled id='' /> */}
